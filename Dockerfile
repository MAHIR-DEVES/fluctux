...
# Define build arguments to pass environment variables during Docker build
ARG MONGO_URI
...
# Set environment variables globally in the image
ENV MONGO_URI=$MONGO_URI \
    ...
    ALGOLIA_WRITE_API=$ALGOLIA_WRITE_API \
